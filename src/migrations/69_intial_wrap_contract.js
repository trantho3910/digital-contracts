...
const TokenSideChain =  artifacts.require("BBToken");
...
module.exports = async function (deployer) {
  ...
  if (deployer.network_id == 3) {
    ...
    //deployer BETH
    deployer.deploy(TokenSideChain,'Bo Ether','BETH',18).then(function(rs){
       console.log('Done');
    });

    // //Update contract
    // deployer.deploy(BBWrap).then(function (rs) {
    //   return  AdminUpgradeabilityProxy.at('0xfe01e2c1ee0014c36a87d08f5951c8ea1a8e4b92').upgradeTo(rs.address);
    // });
